...
- [Modelled soil attributes at high spatial resolution](https://github.com/Sydney-Informatics-Hub/AgReFed-DataHarvester/), so that farmers can make better decisions 🛰️🌱 👨🏿‍🌾
- Engineered a r[adio-astronomy pipeline to detect variable and slow transient light sources](https://www.vast-survey.org/vast-pipeline/) using the Australian Square Kilometre Array Pathfinder 📡 🌞 🌌
